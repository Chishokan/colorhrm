...
<?php else: ?>
    ...
    <div class="card shadow-sm mb-3">
      ...
      <div class="card-body">
        ...
        <p class="mb-0 small text-muted">講師は打刻画面の<strong>「報告（日報）」</strong>で退勤教室の点検項目を<strong>全てチェックして報告</strong>します。<strong>報告すると退勤打刻が押せます</strong>。報告は同画面の一覧で確認できます。</p>
      </div>
    </div>
    ...
    <div class="card shadow-sm mb-3 border-info">
      ...
      <div class="card-body small mb-0">
        講師は<strong>打刻</strong>（出勤/退勤教室を選ぶ。シフトなしでも打刻可。<strong>退勤前に「報告（日報）」で点検項目をチェックして報告すると退勤打刻が押せます</strong>）、<strong>シフト可能登録</strong>（入れる日だけ時間入力）、
